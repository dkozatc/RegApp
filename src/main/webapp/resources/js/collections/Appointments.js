                ...
                success: function (collection) {
                    ...
                    collection.each(function (model) {
                        ...
                        if (resourceModel.length != 0) {
                            fullCalendarEvents.push({id: model.get("id"), title: model.get("CommentsText"), start: new Date(model.get("StartDateTime")),
                                end: new Date(model.get("EndDateTime")), allDay: false, backgroundColor: resourceModel[0].get("color"),
